...
<body>
  <div class="wrapper">
    <center>
    <p class="responsive-text" style="font-size:70px;color:white;margin-top:60px;font-family:Helvetica;text-shadow: 2px 2px 8px rgba(5, 5, 5, 0.62);">You already voted and answered the survey.</p>
    </center>
    <center>
