...
<style>
    ...
    body{
        background-image: url("{{ URL::asset('../assets/images/bgGlass1.jpg') }}");
...
<body>    
    ...
    <section class="container">
        @foreach($positions as $position)
           <div class="row panel active-with-click grid" style="border-left: 4px solid {{$position->strPosColor}};background-color:rgba(0, 0, 0, 0.20)">
                    <div class="col-md-12" style="text-transform: capitalize;">
                        <h3 style="letter-spacing:1px;font-family: helvetica;color: white  ;text-shadow: 1px 1px 4px rgba(6, 5, 5, 0.62);">{{$position->strPosName}}</h3>
                    </div>
